...
class SocialLinks(models.Model):
    ...
    appleStoreLink = models.CharField(max_length=1000,null=True,blank=True,default="")
    googleStoreLink = models.CharField(max_length=1000,null=True,blank=True,default="")
