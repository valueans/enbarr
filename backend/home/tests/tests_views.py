...
class TestHomeAPI(TestCase):
    def setUp(self):
        ...
        self.horse = Horses.objects.create(title="horse 1",location="abc",price=4500.00,description="lorem ipsum",breed="breed 1",gender="mare",age=18,color="black",height="6 ft",temprament="xyz",discipline="xyz")
        self.horse.save()
