        ...
        <Grid container>
            <Grid item xs={2}>
             ...
             <Grid item xs={9} sx={{alignItems:"center",display:"flex"}}>
                 <Box
                   sx={{width: "100%",background: "rgba(0, 0, 0, 0.5)",borderRadius:"0px 12.5px 12.5px 0px",textAlign:"left",pl:3}}>
                     {
                       !horse.userprofile.first_name?
                       <Typography variant='horseDetailsUserName'>{horse.userprofile.user.username}</Typography>
