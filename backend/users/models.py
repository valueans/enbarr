...
class UserSearchSave(models.Model):
    ...
    discipline_id = models.ForeignKey(
        "home.Disciplines", on_delete=models.CASCADE, null=True, blank=True
    )
    gender = models.CharField(max_length=200, null=True, blank=True)
    color_id = models.ForeignKey(
        "home.Colors", on_delete=models.CASCADE, null=True, blank=True
    )
    temperament_id = models.ForeignKey(
